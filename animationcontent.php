<?php
/*
Template Name: Custom Animation Template
*/
...
.main-animation-class{
    ...
    z-index:45;
    background-image: url(https://advaitlabs.com/wp-content/uploads/2021/11/patrn.png);
...
@media screen and (min-width: 53em) {
  ...
  <body class="demo-3 loading">
    ...
    <main class="main-animation-class">
      ...
      <div class="content">
          ...
          <div class="container">
            <div class="group">
              <div class="card">
                <div
                  class="card__img"
                  style="background-image: url(https://ai.advaitmedia.com/wp-content/uploads/2024/04/pexels-googledeepmind-17485608-scaled.jpg)"
                ></div>
              </div>
              <div class="card">
                <div
        ...
        <div class="headings">
          <h1 class="headings__main gloock-regular">Who </h1>
          <h1 class="headings__main gloock-regular">We Are</h1>
          <h5 class="headings_subtitle gloock-regular">Advait Labs</h5>
        </div>
      </div>
    </main>
